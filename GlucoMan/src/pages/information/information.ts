  ...
  constructor(public navCtrl: NavController) {
    this.informationList = [
      ...
      },
      {
        'title': 'Schulungen',
        'icon': 'information',
        'description': '<p>M&ouml;glichst viel &uuml;ber Diabetes zu wissen, bedeutet f&uuml;r Sie,&nbsp;selbst&auml;ndiger zu sein. K&uuml;mmern Sie sich darum, durch Ihren&nbsp;Arzt oder &Auml;rztin, Ihre/n DiabetesfachberaterIn oder Ihre/n&nbsp;Ern&auml;hrungsberaterIn&nbsp;m&ouml;glichst umfassend geschult zu werden.&nbsp;Frischen Sie gelegentlich Ihre Kenntnisse auf. Sprechen&nbsp;Sie Ihren Arzt auf Schulungsangebote oder diabetische Rehabilitationsprogramme&nbsp;an.</p>',
      },
      {
        'title': 'Impressum',
        'icon': 'information',
