  ...
  constructor(public navCtrl: NavController) {
    this.informationList = [
      ...
      },
      {
        'title': 'Autofahren',
        'icon': 'car',
        'description': '<p style="text-decoration: underline;">Allgemein:</p><ul><li>F&uuml;hren Sie<strong> immer rasch verwertbare Kohlenhydrate</strong> (z.B. normale Cola oder Fruchtsaft) und bei Fahrzeiten &uuml;ber einer Stunde Verpflegung f&uuml;r Unterwegs (z.B. Getreidestengel, Obst, Darvida) im Auto mit sich.</li><li>Nehmen Sie Ihr <strong>Blutzuckermessger&auml;t</strong> mit.</li><li>Halten Sie die Essenszeiten ein und verzichten Sie auf das Fahren unter Alkoholeinfluss.</li></ul><p>Sind Sie nicht nur mit <strong>Basalinsulin alleine, Gliclazid (Diamicron) oder mit Gliniden</strong> behandelt, beachten Sie folgendes:</p><p style="text-decoration: underline;">Vor der Fahrt:</p><ul><li>Messen Sie Ihren Blutzucker <strong>vor jeder Fahrt:</strong><ul><li style="list-style-type: circle;">Liegt Ihr Blutzucker <strong>unter 5 mmol/l: <span style="color: #ff0000;">Nicht fahren!</span></strong> Nehmen Sie 20 g Kohlenhydrate (z.B. 2 dl Cola oder Fruchtsaft) zu sich und messen Sie erneut nach 20 Minuten.</li><li style="list-style-type: circle;">Liegt Ihr Blutzucker zwischen 5 und 7 mmol/l: Nehmen Sie 10 g Kohlenhydrate zu sich.</li></ul></ul><p style="text-decoration: underline;">W&auml;hrend der Fahrt:</p><ul><li>Bei <strong>ersten Anzeichen einer Unterzuckerung:</strong></li><br/><ul><li style="list-style-type: circle;"><span style="color: #ff0000;"><strong>Sofort anhalten!</strong></span> <strong>Warnblinkanlage einschalten.</strong> Nehmen Sie 20 g Kohlenhydrate ein. Erst weiterfahren, wenn der Blutzucker &uuml;ber 5 mmol/l liegt.</li></ul><br/><li>Machen Sie bei l&auml;ngeren Fahrten alle 1 bis 1.5 Stunden eine Pause zur Blutzuckerkontrolle und nehmen Sie bei Werten zwischen 5 und 6 mmol/l 10 g Kohlenhydrate ein.</li></ul><p>Mehr Informationen finden Sie hier: <a href="http://www.diabetesschweiz.ch">www.diabetesschweiz.ch</a></p>',
      },
      {
        'title': 'Selbstmanagement',
        'icon': 'person',
        'description': '<p><strong>Regelm&auml;ssige Bewegung</strong> und ein <strong>gesundes K&ouml;rpergewicht&nbsp;</strong>sind wichtig f&uuml;r eine gute Stoffwechselkontrolle:<br /><strong>Rund 150 Minuten Bewegung pro Woche</strong>&nbsp;(30 Minuten an 5 Tagen pro Woche) sind empfohlen. Es muss sich dabei&nbsp;nicht um ein Sportprogramm handeln - im Alltag integrierte&nbsp;Aktivit&auml;t (auf dem Weg zur Arbeit, im Haushalt, in der&nbsp;Freizeit) gen&uuml;gt.</p><p><strong>Vermeiden</strong> Sie &Uuml;bergewicht. <strong>Bei &Uuml;bergewicht</strong> k&ouml;nnen&nbsp;bereits 3-5 kg Gewichtsverlust Ihre Blutzucker-, Blutdruck- und&nbsp;Blutfettwerte verbessern. Streben Sie eine <strong>langsame,&nbsp;</strong><strong>nachhaltige Gewichtsabnahme</strong> an.</p><p><span style="color: #ff0000;"><strong>1. Realistische Ziele setzen und festhalten</strong></span><br/>Wichtig ist, dass Sie sich regelm&auml;ssig Ziele setzen, die Sie&nbsp;auch erreichen k&ouml;nnen. <strong>Halten Sie diese schriftlich fest.</strong></p><p><span style="color: #ff0000;"><strong>2. Konkrete Massnahmen planen</strong></span><br/>Suchen Sie ganz bewusst nach M&ouml;glichkeiten, Ihre Ziele zu&nbsp;erreichen. <strong>Planen Sie</strong>, welche <strong>Massnahmen Sie konkret&nbsp;</strong><strong>umsetzen</strong> wollen (z.B. einmal pro Woche mit dem Velo zur&nbsp;Arbeit fahren, nach dem Nachtessen nicht naschen, usw.).</p><p><span style="color: #ff0000;"><strong>3. Erfolg kontrollieren und sich belohnen</strong></span><br/><strong>Kontrollieren</strong> Sie regelm&auml;ssig Ihren <strong>Fortschritt</strong> und steigern&nbsp;Sie Ihre Ziele, wenn Sie diese erreicht haben. Vergessen Sie&nbsp;nicht, sich f&uuml;r das Erreichen Ihrer Ziele auch zu <strong>belohnen</strong>!&nbsp;Sollten Sie Ihr Ziel nicht erreichen, so <strong>lassen Sie sich nicht&nbsp;</strong><strong>entmutigen</strong>! Besprechen Sie mit einer Fachperson oder&nbsp;Gleichbetroffenen, <strong>was Sie daran gehindert</strong> hat - vielleicht&nbsp;finden Sie gemeinsam kreative L&ouml;sungsideen.</p>',
      },
      {
        'title': 'Impressum',
        'icon': 'information',
        'description': '<p>Herausgeber:<br/>Berner Fachhochschule, Technik und Informatik<br />Medizininformatik</p><p>Diese Applikation wurden von den Studenten Kaspar Schmocker und Fabian Zwahlen im Rahmen der Bachelorarbeit entwickelt.</p><p>Wenn Sie spezieller Hilfe bed&uuml;rfen oder zus&auml;tzliche Informationen&nbsp;haben m&ouml;chten, fragen Sie Ihren Arzt, Ihren Apotheker&nbsp;oder Ihre regionale Diabetesgesellschaft nach entsprechenden M&ouml;glichkeiten.</p>',
      },
    ]
  }
