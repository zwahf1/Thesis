...
import * as TYPES from '../../util/typings/Range_Types';
...
export class TargetrangePage {
  ...
  this.vitalRangeList = [new VitalRange('Glukose', 3.6, 7.7, 'mmol/L', new Date), new VitalRange('Diastolischer BD', 70,89, 'mmHg', new Date)];
  ...
  this.vitalRangeList.push(new VitalRange('HbA1C', 4.5, 7.5, '%', new Date));
